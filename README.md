...
- 課題レビューでコードが載っている時がありますが、全部選択するのが面倒なので、clickするだけでコピーするボタンを設置しました。  
![](https://i.gyazo.com/7f96e375975714d8160dd7a9fba0bc4f.png)

#### 課題レビューDIFF機能
- Mergely の機能を取り込みました。レビュー時に比較ツールを起動するリンクが表れます。  
![](https://gyazo.com/72ebd0141020b89c6691f6c8f19bdc90.png)
- Mergelyに「コメントを削除」と「空行の削除」のボタンを付けています。  
また、ドロップダウンで比較するレビューのコードを選ぶことができます。  
![](https://gyazo.com/ea82cc0038d89daf0a079685cb4b018f.png)
...
- `0.5.2` 別カリキュラムを追加
- `0.5.1` 課題レビュー時の解答コードをコピーできるボタンを設置
