...
### Slackの新規課題レビュー到着監視機能（ベータ版）
- **試験的な機能です。実際のレビュー到着はチャンネルに届くメッセージを確認してください。**
- Slackの課題レビューbotからの「課題を提出」という文字を監視し、到着したら通知を表示します。  
Slackの課題レビューチャンネルを開いておかなくても問題ないはずです。  
...
- 設定でON/OFFが可能です。
- 一度でもカリキュラムにアクセスしていると、設定でサブメニューの項目の表示／非表示を制御出来ます。  
...
一度でもカリキュラムを見ていると、ここにカリキュラムの一覧が出ます。チェックボックスをON/OFFすることで、サブメニューに表示するカリキュラムを選択することが出来ます。
    - **課題レビュー基準の表示・非表示**  
一度でも課題レビューのページを見ていると、ここに課題レビュー基準の一覧が出ます。チェックボックスをON/OFFすることで、課題レビュー基準の一覧から隠すことが出来ます。
    - **AWSのログイン情報**  
